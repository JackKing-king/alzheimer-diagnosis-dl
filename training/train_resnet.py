...
def main(args):
    ...
    print(f"Creating ResNet-{args.model_name} model...")
    model = get_resnet_model(
        model_name=f'resnet{args.model_name}',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='50', choices=['18', '34', '50', '101', '152'])
