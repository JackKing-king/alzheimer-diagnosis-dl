...
def main(args):
    ...
    print(f"Creating ViT-{args.model_name} model...")
    model = get_vit_model(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='results/vit')
    parser.add_argument('--model_name', type=str, default='base', choices=['tiny', 'small', 'base', 'large'])
